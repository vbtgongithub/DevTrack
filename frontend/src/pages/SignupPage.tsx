...
export const SignupPage: React.FC = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-dt-bg font-sans selection:bg-dt-primary/15 selection:text-dt-text py-12">
      {/* ─── Background Effects ─── */}
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          >
            Start your developer journey with DevTrack.
          </motion.p>
        </div>
