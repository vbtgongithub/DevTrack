...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="py-16 bg-[#F7F6F3] border-t border-[rgba(15,23,42,0.06)]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-6 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-[#0F172A]">DevTrack</span>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="text-[#94A3B8] hover:text-[#0F172A] transition-colors">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <div className="text-sm font-semibold text-[#0F172A] mb-4">{category}</div>
        ...
        <div className="pt-8 border-t border-[rgba(15,23,42,0.06)] flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-[#94A3B8]">
            ...
            <a href="#" className="hover:text-[#0F172A] transition-colors">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
