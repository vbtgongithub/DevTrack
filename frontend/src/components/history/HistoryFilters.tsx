  ...
  return (
    <div className="bg-white shadow-sm rounded-2xl p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 ease-out border border-gray-200">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <h3 className="text-lg font-semibold text-gray-900 tracking-tight">Filters</h3>
      </div>
            ...
            <button
              ...
              className={[
                ...
                isActive
                  ...
                  : 'bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700 hover:scale-[1.02]',
              ].join(' ')}
            >
