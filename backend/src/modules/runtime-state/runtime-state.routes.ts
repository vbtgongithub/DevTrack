...
router.post('/rebuild', authMiddleware, runtimeStateController.rebuildRuntimeState.bind(runtimeStateController));

// POST /api/runtime-state/invalidate — invalidate runtime state
router.post('/invalidate', authMiddleware, runtimeStateController.invalidateRuntimeState.bind(runtimeStateController));
